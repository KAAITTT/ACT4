...
att.PrintName = "Floodlight"
att.Name = "att_acc_floodlight"
att.Slot = "accessory"
att.Description = {"Attachable weapon flashlight.", "Blinds enemies and provides light.", "Wide beam, but weaker light."}
...
att.WMParts = {
    ...
    renderfunc = function(pos, ang, ent, slotid, asvm)
        ...
        ACT3_DoFlashlight(pos, ang, ent, slotid, flashmat, 400, 1.5, 125)
    end
    }
}
