...
att.PrintName = "Predator Infrared Scope"
att.Name = "att_sight_predator"
att.Slot = "sight"
att.Description = {"Thermal vision scope.", "Provides 1-3x magnification.", "Rainbow Version."}
...
att.AttachFunc = function(wep)
    ...
    wep.ThermalVisionTexture = Material("effects/thermalvision.png")
end
