...
att.PrintName = "M203 SMK"
att.Name = "att_ubgl_m203smk"
att.Slot = "foregrip"
att.Description = {"Underbarrel grenade launcher.", "Fires smoke grenades."}
att.Icon = Material("attachments/att_ubgl_m203.png")

att.InvAtt = "att_ubgl_m203he"
...
att.AttachFunc = function(wep)
    ...
    wep.UBGL_Rounds = 0
    wep.UBGL_Firemode = "M203SMK UBGL"
