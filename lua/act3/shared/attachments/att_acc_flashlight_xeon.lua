...
att.PrintName = "Xeon Flashlight"
att.Name = "att_acc_flashlight_xeon"
att.Slot = "accessory"
att.Description = {"Attachable weapon flashlight.", "Blinds enemies and provides light.", "Bright blue beam for extra light.", "Narrower than usual."}
...
att.WMParts = {
    ...
    renderfunc = function(pos, ang, ent, slotid, asvm)
        ...
        ACT3_DoFlashlight(pos, ang, ent, slotid, flashmat, 750, 3, 50, Color(175, 175, 255))
    end
    }
}
