...
att.PrintName = "AK Short Polymer Handguard"
att.Name = "ak_handguard_poly_short"
...
att.Icon = Material("attachments/ak_handguard_poly_short.png")

att.BodygroupMods = {"ak_handguard_poly_short"}
