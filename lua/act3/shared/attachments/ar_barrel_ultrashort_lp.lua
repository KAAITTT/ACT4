...
att.PrintName = "AR Commando Barrel (LP)"
att.Name = "ar_barrel_ultrashort_lp"
att.Slot = "ar_barrel"
att.Description = {"+35% Fire Rate", "+35% Accuracy Recovery", "-45% Precision", "-35% Muzzle Velocity"}
att.Icon = Material("attachments/ar_barrel_ultrashort_lp.png")
...
att.BodygroupMods = {"ar_barrel_ultrashort_lp"}
