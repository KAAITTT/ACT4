...
bullet.Name = "12g_bird" -- the bullet's code name
bullet.PrintName = "12 Gauge BIRD" -- the displayed bullet name
bullet.Type = "BIRD"

bullet.Description = ACT3.Descriptions.BIRD

bullet.Calibre = "12g" -- determines what types of magazines this bullet can fit in

bullet.CaseEffect = "act3_case_12g_bird" -- the visual shell ejection effect of the bullet

bullet.BaseDamage = 5
bullet.HalfwayDist = 2100
...
bullet.DamageMult_Materiel = 0.15 -- default: 0.75
