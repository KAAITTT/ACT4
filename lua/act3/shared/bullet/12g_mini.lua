...
bullet.Name = "12g_mini" -- the bullet's code name
bullet.PrintName = "12 Gauge MINI" -- the displayed bullet name
bullet.Type = "MINI"

bullet.Description = {"Miniature 12 gauge shell.", "Extra shells can be fit in a tube."}
