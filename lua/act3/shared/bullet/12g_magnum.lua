...
bullet.Name = "12g_magnum" -- the bullet's code name
bullet.PrintName = "12 Gauge Magnum" -- the displayed bullet name
bullet.Type = "MAG"

bullet.Description = {"Round containing 8 lead pellets and hi-pressure load.", "Better long-range damage and muzzle velocity."}

bullet.Calibre = "12g" -- determines what types of magazines this bullet can fit in

bullet.CaseEffect = "act3_case_12g_magnum" -- the visual shell ejection effect of the bullet

bullet.BaseDamage = 15
bullet.HalfwayDist = 8400
...
bullet.RecoilMult = 2 -- weapon recoil multiplier
